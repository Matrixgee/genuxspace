...
const Deposit = () => {
  ...
  return (
    <div className="h-[calc(100vh-4rem)] bg-gradient-to-br from-gray-800 via-gray-900 to-purple-800 py-8 px-4 overflow-y-scroll scrollbar-thin">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -inset-10 opacity-50">
          ...
          <div className="absolute top-3/4 right-1/4 w-72 h-72 bg-purple-400/20 rounded-full mix-blend-multiply filter blur-xl animate-pulse delay-700"></div>
          <div className="absolute bottom-1/4 left-1/3 w-72 h-72 bg-purple-600/20 rounded-full mix-blend-multiply filter blur-xl animate-pulse delay-1000"></div>
        </div>
      </div>
      ...
      {showTransactionDetails ? (
        <div className="relative max-w-2xl mx-auto">
          ...
          <div className="mb-8">
            <button
              className="flex items-center gap-3 text-purple-200 hover:text-white transition-all duration-300 group"
              onClick={handleBack}
            >
          ...
          <div className="bg-gray-800/40 backdrop-blur-xl border border-purple-600 rounded-3xl p-8 shadow-2xl">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-purple-200 mb-4 bg-gradient-to-r from-purple-400 to-purple-200 bg-clip-text text-transparent">
                Transaction Details
              </h2>
            ...
            {/* Wallet Address */}
            <div className="mb-8">
              <div className="bg-gray-800/60 border border-purple-600 rounded-2xl p-4 backdrop-blur-sm">
                <div className="flex items-center justify-between gap-4">
                  <p className="text-purple-100 font-mono text-sm break-all flex-1">
                  ...
                  <button
                    ...
                    className="p-3 bg-gradient-to-r from-purple-600 to-purple-500 rounded-xl hover:from-purple-700 hover:to-purple-600 transition-all duration-300 transform hover:scale-105"
                  >
            ...
            {showProofOfPayment && (
              <div className="border-t border-purple-700 pt-6 space-y-4">
                <div className="text-center">
                  <label className="text-purple-200 font-medium block mb-4">
                  ...
                  <label
                    ...
                    className="inline-block cursor-pointer bg-gradient-to-r from-purple-600 to-purple-500 hover:from-purple-700 hover:to-purple-600 text-white py-3 px-8 rounded-xl transition-all duration-300 transform hover:scale-105 font-medium"
                  >
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-2xl font-bold text-purple-200 mb-4 bg-gradient-to-r from-purple-400 via-purple-300 to-purple-200 bg-clip-text text-transparent">
              Fund Your Account
            </h1>
            <div className="w-32 h-1 bg-gradient-to-r from-purple-600 via-purple-500 to-purple-400 mx-auto rounded-full"></div>
          </div>
          ...
          <div className="max-w-2xl mx-auto space-y-12">
            {/* Amount Input */}
            <div className="bg-gray-800/40 backdrop-blur-xl border border-purple-600 rounded-3xl p-8 shadow-2xl">
              <label className="block text-purple-200 text-xl font-semibold mb-4">
                Amount to Deposit
              </label>
              <div className="relative">
                <input
                  ...
                  className="w-full h-16 bg-gray-800/60 border border-purple-600 rounded-2xl px-6 text-purple-100 text-xl placeholder-purple-300 outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-500/50 transition-all duration-300"
                />
            ...
            {/* Payment Methods */}
            <div className="bg-gray-800/40 backdrop-blur-xl border border-purple-600 rounded-3xl p-8 shadow-2xl">
              <h3 className="text-purple-200 text-xl font-semibold mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div
                  className={`relative p-6 rounded-2xl cursor-pointer transition-all duration-300 transform hover:scale-105 ${
                    selectedPaymentMethod === "btc"
                      ...
                      : "bg-gray-800/40 border border-purple-600 hover:bg-gray-700/60 hover:border-purple-500"
                  }`}
                  onClick={() => setSelectedPaymentMethod("btc")}
                >
                  <div className="text-center space-y-4">
                    <FaBtc className="text-5xl text-orange-400 mx-auto" />
                    <p className="text-purple-100 font-semibold text-lg">Bitcoin</p>
                  </div>
                  {selectedPaymentMethod === "btc" && (
                ...
                >
                  <div className="text-center space-y-4">
                    ...
                    <p className="text-purple-100 font-semibold text-lg">Ethereum</p>
                  </div>
                  {selectedPaymentMethod === "eth" && (
                ...
                >
                  <div className="text-center space-y-4">
                    ...
                    <p className="text-purple-100 font-semibold text-lg">USDT</p>
                  </div>
                  {selectedPaymentMethod === "usdt" && (
            ...
            <div className="text-center">
              <button
                className="w-full max-w-md py-4 bg-gradient-to-r from-purple-600 to-purple-500 hover:from-purple-700 hover:to-purple-600 text-white font-bold text-xl rounded-2xl transition-all duration-300 transform hover:scale-[1.02] shadow-2xl hover:shadow-purple-500/25"
