  ...
  const GetUser = async () => {
    try {
      const response = await axios.get(
        `https://gen-75n5.onrender.com/api/user/userprofile/${id}`,
        {
...
if (!user) {
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-gray-800 via-[#2d1b47] to-purple-800">
        <motion.div
        ...
        >
          ...
          <p className="text-xl text-purple-100">Loading your dashboard...</p>
        </motion.div>
      </div>
    );
  }
  ...
  // );
  return (
  <div className="w-full h-[100%] scrollbar-thin overflow-y-scroll bg-gradient-to-br from-gray-800 via-gray-900 to-purple-800">
    {/* Header Section */}
    <motion.div
      className="px-6 py-8"
      initial={{ opacity: 0, y: -20 }}
    ...
    >
      <div className="max-w-7xl mx-auto">
        <motion.h1
          className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-purple-400 to-purple-200 bg-clip-text text-transparent mb-2"
          initial={{ opacity: 0, x: -20 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ delay: 0.2, duration: 0.6 }}
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {CardContent.map((item) => (
            <motion.div
              ...
              className="relative overflow-hidden rounded-2xl bg-gray-800/40 backdrop-blur-md border border-purple-600 p-6 shadow-xl hover:bg-gray-700/60 hover:border-purple-500 transition-all duration-300"
            >
              {/* Gradient overlay */}
              <div
                className={`absolute inset-0 bg-gradient-to-br ${item.bg} opacity-5`}
              ...
              {/* Animated border */}
              <div
                className="absolute inset-0 rounded-2xl border-2 border-transparent bg-gradient-to-r from-purple-500/50 to-purple-400/50 opacity-0 transition-opacity duration-300 group-hover:opacity-100"
                style={{
                  mask: "linear-gradient(#fff 0 0) content-box, linear-gradient(#fff 0 0)",
                  maskComposite: "xor",
                }}
    ...
    >
      <div className="max-w-7xl mx-auto space-y-12">
        {/* Personal Trading Chart */}
        <div className="bg-gray-800/40 backdrop-blur-md rounded-2xl border border-purple-600 overflow-hidden shadow-2xl">
          ...
          <div className="p-6">
            <div
              className="bg-gray-800/60 rounded-xl overflow-hidden"
              style={{ height: "400px" }}
            >
              <TradingViewOne />
            </div>
